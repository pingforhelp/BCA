...
**Ans:**  The educational reforms suggested by the School of Barbiana focus on social justice and removing the class-based selection that exists in traditional schooling. The main goal is to transform the school from an institution that **reproduces inequality** into one that **serves the poor and empowers marginalized students**.
Reforms:
