...
- Describe machine-level, assembly-level, and high-level programming languages. Explain their advantages and disadvantages.  
- What are Operators in C? Explain categories with examples.  
...
- Describe loop control statements (while, for, do-while). Compare their working.  
- Write a menu-driven C program using switch and loops (calculator, grade system, electricity bill).
...
- Explain two-dimensional arrays: declaration, initialization, and memory representation.
